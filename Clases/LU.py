...
if __name__ == '__main__':
    ...
    A3 = np.matrix('25 15 -5 -10 5;15 10 1 -7 -8;-5 1 21 4 5;-10 -7 4 1 8; -10 -7 4 1 8',float)
    b = numpy.matrix('11;70;17;10;15')
    b2 = np.matrix('-25;-19;-21;-5')
    A4 = np.matrix('3 -4 1;1 1 1;2 1 -4')
    b4 = np.matrix('-1; -0.25; -1.25')
